...
class PrintLoadedTranslationsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('canabelle:cms:translation:print-loaded-translations')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $cataloguesDB = $em->getRepository("CanabelleCMSTranslationBundle:LanguageCatalogue")->findAll();
        $translations = [];

        /** @var LanguageCatalogue $ctlg */
